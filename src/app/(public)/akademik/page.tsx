  ...
  const academicFeatures = [
    {
      ...
      description:
        "Penjelasan mengenai kurikulum, metode pembelajaran, dan standar kompetensi siswa.",
    ...
    },
    {
      ...
      description:
        "Informasi kegiatan pengembangan minat dan bakat siswa di luar jam pelajaran.",
      action: "Lihat Ekskul",
    ...
    },
    {
      ...
      description:
        "Jadwal kegiatan sekolah, ujian semester, dan agenda penting lainnya.",
    ...
    },
    {
      ...
      description:
        "Profil lengkap sarana dan prasarana penunjang kegiatan belajar mengajar.",
    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <div className="bg-blue-900 py-16 border-b border-white/10">
        <div className="container mx-auto px-4 text-center">
          <span className="text-blue-200 font-semibold tracking-wide uppercase text-sm mb-2 block">
            Informasi Akademik
          </span>
          ...
          <p className="text-blue-100 max-w-2xl mx-auto">
            Mengedepankan standar pendidikan berkualitas dengan kurikulum yang
            adaptif dan metode pembelajaran yang inovatif untuk mencetak lulusan
            kompeten.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          {academicFeatures.map((feature, idx) => (
            <Link
              href={feature.href}
              key={idx}
              className="bg-white p-8 rounded-2xl border border-slate-200 hover:shadow-xl hover:border-blue-200 transition-all group block"
            >
            ...
            <section className="bg-white p-8 rounded-2xl border border-slate-200 relative">
              ...
              >
                {pageContent ? (
                  ...
                  <>
                    <p>
                      SMK Enscho menerapkan sistem pembelajaran berbasis proyek
                      (Project Based Learning) yang terintegrasi dengan
                      industri. Setiap siswa tidak hanya belajar teori, tetapi
                      juga terlibat langsung dalam proyek nyata yang relevan
                      dengan kompetensi keahliannya.
                    </p>
                    <ul className="list-disc pl-5 space-y-2 mt-4">
                      <li>
                        <strong>Teaching Factory (TEFA):</strong> Pembelajaran
                        berbasis produksi/jasa yang mengacu pada standar dan
                        prosedur industri.
                      </li>
                      <li>
                        <strong>Sertifikasi Kompetensi:</strong> Uji kompetensi
                        keahlian (UKK) bekerjasama dengan LSP dan Dunia
                        Industri.
                      </li>
                      <li>
                        <strong>Program Magang (PKL):</strong> Praktik kerja
                        lapangan minimal 6 bulan di perusahaan mitra berskala
                        nasional/internasional.
                      </li>
                      <li>
                        <strong>Kelas Industri:</strong> Kelas khusus yang
                        kurikulumnya disinkronisasi langsung dengan kebutuhan
                        industri mitra.
                      </li>
                    </ul>
                    <p className="text-sm text-slate-400 mt-6 italic">
                      *Konten ini dapat diubah melalui Admin Panel (Menu Halaman{" "}
                      {">"} Buat baru dengan slug:{" "}
                      <strong>akademik-landing</strong>)
                    </p>
                  </>
                )}
              </div>
          ...
          <div className="space-y-8">
                ...
                {documents.length > 0 ? (
                  documents.map((file) => (
                    <a
                      ...
                      className="flex items-center justify-between p-3 bg-slate-50 rounded-lg hover:bg-blue-50 transition-colors cursor-pointer group"
                    >
            ...
            <div className="bg-blue-600 p-8 rounded-2xl text-white text-center">
              ...
              <p className="text-blue-100 text-sm mb-6">
                Silakan hubungi bagian akademik atau tata usaha kami untuk
