    ...
    <div className="bg-slate-50 min-h-screen">
       <div className="bg-blue-600 text-white border-b border-blue-700">
          <div className="container mx-auto px-4 py-16 text-center">
             <span className="text-blue-200 font-semibold tracking-wide uppercase text-sm">Bursa Kerja Khusus</span>
             <h1 className="text-3xl md:text-5xl font-bold mt-2 mb-6">Info Lowongan Kerja</h1>
             <p className="text-blue-100 max-w-2xl mx-auto text-lg leading-relaxed">
                Temukan peluang karir terbaik dari mitra industri kami. Informasi lowongan kerja terupdate khusus untuk alumni dan siswa tingkat akhir.
             </p>
          </div>
       </div>
       ...
       <div className="container mx-auto px-4 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
             {jobPosts.length > 0 ? (
               jobPosts.map((post) => (
                  <div key={post.id} className="bg-white rounded-2xl overflow-hidden border border-slate-200 hover:shadow-xl transition-all duration-300 flex flex-col group">
                      ...
                      <div className="p-6 flex-1 flex flex-col">
                         <div className="flex items-center gap-3 text-xs text-slate-500 mb-4">
                            ...
                            <span className="flex items-center gap-1"><Building2 size={12}/> Mitra Industri</span>
                         </div>
               ...
               <div className="col-span-full py-20 text-center">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-2">Belum ada lowongan tersedia</h3>
                  <p className="text-slate-500 max-w-md mx-auto">
                     Saat ini belum ada informasi lowongan kerja baru. Silakan cek kembali secara berkala atau hubungi bagian BKK sekolah.
                  </p>
               </div>
             )}
          </div>
