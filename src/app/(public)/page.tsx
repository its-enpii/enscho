...
export default async function Home() {
  ...
  const sambutanContent = sambutanPage?.content || "<p>Selamat datang di website resmi kami. Kami berkomitmen mencetak lulusan berkualitas.</p>";
  ...
  const defaultStats = {
     ...
     teachers: await prisma.employee.count({ where: { category: { not: "KEPSEK" } } }),
