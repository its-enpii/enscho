      ...
      <div className="bg-blue-900 py-16 border-b border-white/10">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 max-w-2xl mx-auto">
            SMK Enscho menawarkan berbagai pilihan jurusan yang relevan dengan
            kebutuhan industri saat ini, didukung dengan fasilitas praktik yang
            lengkap dan kurikulum standar industri.
          </p>
        </div>
      </div>
              ...
              >
                ...
                <div className="p-8 flex-1 flex flex-col">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center text-blue-600 font-bold hover:gap-2 transition-all mt-auto"
                  >
